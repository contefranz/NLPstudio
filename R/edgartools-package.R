...
#'
#' @description NLPStudio provides a suite of parallel, efficient, and easy-to-use functions 
...
#'
#' @details \pkg{NLPStudio} excels in constructing and manipulating textual data 
...
#' underlying C++ integration for critical operations and explicit parallel processing.
#'
...
#' analytics.
#'
#' @details \pkg{NLPStudio} integrates smoothly with other R and C++ libraries, 
